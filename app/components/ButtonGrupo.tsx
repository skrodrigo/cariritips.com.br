...
const ButtonGrupo = () => {
  return (
    <div className="container mx-auto px-4 relative flex justify-center mt-20">
      <Image src="/luz.png" width={100} height={100} alt="" className="absolute -z-10 inset-0 m-auto" quality={100} />
      <Link 
      ...
      >
        Grupo do Telegram
        <Image src="/Telegram.svg" alt="Telegram Icon" width={40} height={40} className="w-8 h-8 sm:w-9 sm:h-9 md:w-10 md:h-10" quality={100} />
      </Link>
    </div>
  )
}
